...
public class RoundProgressView extends View {
  ...
  private void init(Context context, @Nullable AttributeSet attrs) {
    ...
    mCorner = typedArray.getDimensionPixelOffset(R.styleable.RoundProgressView_circleCorner, 0);
    mStartAngle = typedArray.getInt(R.styleable.RoundProgressView_startAngle, 315);
    mBackgroundColor = typedArray.getColor(R.styleable.RoundProgressView_backgroundColor,
  ...
  @Override protected void onSizeChanged(int w, int h, int oldw, int oldh) {
    ...
    mStart =
        new PointF((float) (mCenter.x + mRadius * Math.cos(mStartAngle * Math.PI / PI_RADIUS)),
