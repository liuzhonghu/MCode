...
public class BitmapUtils {
  ...
  public static Bitmap decodeSampleBitMapFromFile(Context context, String filePath,
      float sampleScale) {
    //先得到bitmap的高宽
  ...
  public static BitmapFactory.Options sampleBitmapOptions(Context context,
