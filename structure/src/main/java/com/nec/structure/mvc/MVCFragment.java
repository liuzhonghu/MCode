...
import com.nec.structure.data.DataCallback;
import com.nec.structure.data.DataClient;
 ...
 *
 * 控制层(Controller)
 * Android的控制层的重任通常落在了众多的Activity的肩上。这句话也就暗含了不要在Activity中写代码，
...
public class MVCFragment extends BaseFragment {
  ...
  private void getLucky() {
    ...
    DataClient.getData(Integer.valueOf(content), data -> {
      if (data != null) {
