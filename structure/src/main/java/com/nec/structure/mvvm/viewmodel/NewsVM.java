package com.nec.structure.mvvm.viewmodel;

import com.nec.structure.mvvm.INewsView;
...
import com.nec.structure.mvvm.constant.MainConstant;
import com.nec.structure.mvvm.model.INewsModel;
import com.nec.structure.mvvm.model.NewsModelImpl;
...
public class NewsVM implements BaseLoadListener<SimpleNewsBean> {
  ...
  @Override public void loadSuccess(List<SimpleNewsBean> list) {
    if (currPage > 1) {
      //上拉加载的数据
  ...
  @Override public void loadStart() {
