...
import com.nec.fpsactor.Calculation;
import com.nec.fpsactor.FPSConfig;
...
public class Coach {
  ...
  public Coach(Application context, FPSConfig config) {
  ...
  private void addViewToWindow(View view) {
    ...
    WindowManager.LayoutParams paramsF =
        new WindowManager.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
            ViewGroup.LayoutParams.WRAP_CONTENT, permissionFlag,
    ...
    GestureDetector gestureDetector =
        new GestureDetector(view.getContext(), simpleOnGestureListener);

    // attach touch listener
    view.setOnTouchListener(new ActorTouchListener(paramsF, windowManager, gestureDetector));
  ...
  public void showData(FPSConfig fpsConfig, List<Long> dataSet) {
    ...
    AbstractMap.SimpleEntry<Calculation.Metric, Long> answer =
