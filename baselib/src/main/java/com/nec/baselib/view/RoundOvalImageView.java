 ...
 * @desc 使用BitmapShader类实现圆形、圆角，椭圆等自定义图片View
 * @since 2018/10/29
 */
public class RoundOvalImageView extends AppCompatImageView {
  ...
  public RoundOvalImageView(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public RoundOvalImageView(Context context, AttributeSet attrs, int defStyle) {
  ...
  private void initView(Context context, @Nullable AttributeSet attrs) {
    TypedArray typedArray =
        context.obtainStyledAttributes(attrs, R.styleable.RoundOvalImageView);
    mRadius = typedArray.getDimensionPixelOffset(R.styleable.RoundOvalImageView_radius, 0);
    mType = typedArray.getInt(R.styleable.RoundOvalImageView_overType, 0);
    typedArray.recycle();
